...
private:
    ...
    // Калибровка сканирующих линий (хранение целых линий изображения)
    bool hasCalibration_;            // Есть ли сохраненная калибровка
    uint8_t* calibrationLines_[4];   // Калибровочные данные для 4 горизонтальных линий (по 160 пикселей каждая)
